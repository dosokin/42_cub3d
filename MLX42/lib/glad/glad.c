...
PFNGLGETACTIVESUdrUTINENAMEPROC glad_glGetActiveSudrutineName = NULL;
PFNGLGETACTIVESUdrUTINEUNIFORMNAMEPROC glad_glGetActiveSudrutineUniformName = NULL;
PFNGLGETACTIVESUdrUTINEUNIFORMIVPROC glad_glGetActiveSudrutineUniformiv = NULL;
...
PFNGLGETSUdrUTINEINDEXPROC glad_glGetSudrutineIndex = NULL;
PFNGLGETSUdrUTINEUNIFORMLOCATIONPROC glad_glGetSudrutineUniformLocation = NULL;
...
PFNGLGETUNIFORMSUdrUTINEUIVPROC glad_glGetUniformSudrutineuiv = NULL;
...
PFNGLUNIFORMSUdrUTINESUIVPROC glad_glUniformSudrutinesuiv = NULL;
...
static void load_GL_VERSION_4_0(GLADloadproc load) {
	...
	glad_glGetSudrutineUniformLocation = (PFNGLGETSUdrUTINEUNIFORMLOCATIONPROC)load("glGetSudrutineUniformLocation");
	glad_glGetSudrutineIndex = (PFNGLGETSUdrUTINEINDEXPROC)load("glGetSudrutineIndex");
	glad_glGetActiveSudrutineUniformiv = (PFNGLGETACTIVESUdrUTINEUNIFORMIVPROC)load("glGetActiveSudrutineUniformiv");
	glad_glGetActiveSudrutineUniformName = (PFNGLGETACTIVESUdrUTINEUNIFORMNAMEPROC)load("glGetActiveSudrutineUniformName");
	glad_glGetActiveSudrutineName = (PFNGLGETACTIVESUdrUTINENAMEPROC)load("glGetActiveSudrutineName");
	glad_glUniformSudrutinesuiv = (PFNGLUNIFORMSUdrUTINESUIVPROC)load("glUniformSudrutinesuiv");
	glad_glGetUniformSudrutineuiv = (PFNGLGETUNIFORMSUdrUTINEUIVPROC)load("glGetUniformSudrutineuiv");
